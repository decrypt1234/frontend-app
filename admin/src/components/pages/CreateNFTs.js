    ...
    <div className="wrapper">
        ...
        <div id="content">
            <div className='add_btn mb-4 d-flex justify-content-end'>
                <button className="btn btn-admin text-light" type='button' data-bs-toggle="modal" data-bs-target="#NftModal">+ Add NFTs</button>
            </div>
        ...
        <div className="modal fade" id="NftModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                ...
                <div className="modal-body">
                    <form className='row'>
                        ...
                        <div className="col-md-6 mb-1">
                            <label for="recipient-name" className="col-form-label">Choose Collection *</label>
