    ...
    <div className="row">
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list1.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
                            <h6>BARRETT GUNS #2454</h6>
                        </div>
                    </div>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list2.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list3.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list4.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list5.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list6.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list7.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list8.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list9.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list10.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list11.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
        ...
        <div className="col-md-3 mb-4">
            <div className="collection_items">
                <img alt='' src={'../img/collections/list12.png'} class="img-fluid" />
                <div className="coll_itemstext">
                    <div className="collection_row mb-3">
                        <div className="collection_col">
                            <span>Barrett Collection</span>
