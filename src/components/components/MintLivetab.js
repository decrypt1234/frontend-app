...
export default function MintLivetab() {
  return (
    <div className="container">
        <ul className="nav nav-pills mb-5 mint_tab" id="pills-tab" role="tablist">
            <li className="nav-item" role="presentation">
                <button className="nav-link active" id="liveMint-tab" data-bs-toggle="live" data-bs-target="#liveMint" type="button" role="tab" aria-controls="liveMint" aria-selected="true">live</button>
            </li>
        </ul>
