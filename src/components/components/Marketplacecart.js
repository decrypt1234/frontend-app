  ...
  return (
    <div className='row'>
        <div className="col-md-3 mb-4">
            ...
            <img alt='' src={'../img/Marketplacecollection/HeadDownAR-1.png'} class="img-fluid items_img" />
        ...
        <div className="col-md-3 mb-4">
            ...
            <img alt='' src={'../img/Marketplacecollection/HeadDownAR-2.png'} class="img-fluid items_img" />
            <div className='items_text'>
                <div className='items_info'>
                <div className='items_left'>
                    <h3 className=''>Name Last Name</h3>
        ...
        <div className="col-md-3 mb-4">
            ...
            <img alt='' src={'../img/Marketplacecollection/HeadDownAR-3.png'} class="img-fluid items_img" />
            <div className='items_text'>
                <div className='items_info'>
                <div className='items_left'>
                    <h3 className=''>Name Last Name</h3>
        ...
        <div className="col-md-3 mb-4">
            <div className='items_slide'>
                ...
                <img alt='' src={'../img/Marketplacecollection/HeadDownAR-4.png'} class="img-fluid items_img" />
                <div className='items_text'>
                    <div className='items_info'>
                    <div className='items_left'>
                        <h3 className=''>Name Last Name</h3>
        ...
        <div className="col-md-3 mb-4">
            ...
            <img alt='' src={'../img/Marketplacecollection/HeadDownAR-5.png'} class="img-fluid items_img" />
            <div className='items_text'>
                <div className='items_info'>
                <div className='items_left'>
                    <h3 className=''>Name Last Name</h3>
        ...
        <div className='items_slide'>
          ...
          <img alt='' src={'../img/Marketplacecollection/HeadDownAR-6.png'} class="img-fluid items_img" />
          <div className='items_text'>
            <div className='items_info'>
              <div className='items_left'>
                <h3 className=''>Name Last Name</h3>
        ...
        <div className='items_slide'>
          ...
          <img alt='' src={'../img/Marketplacecollection/HeadDownAR-7.png'} class="img-fluid items_img" />
          <div className='items_text'>
            <div className='items_info'>
              <div className='items_left'>
                <h3 className=''>Name Last Name</h3>
        ...
        <div className='items_slide'>
          ...
          <img alt='' src={'../img/Marketplacecollection/HeadDownAR-8.png'} class="img-fluid items_img" />
          <div className='items_text'>
            <div className='items_info'>
              <div className='items_left'>
                <h3 className=''>Name Last Name</h3>
