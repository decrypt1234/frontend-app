      ...
      <nav className="navbar navbar-expand-lg">
        <div className="nav-container container">
            ...
            <ul className="navbar-nav me-auto align-items-center mb-2 mb-lg-0">
                <li className="nav-item">
                  ...
                  <ul className="sub_menu">
                    ...
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14.0753 22.6541V25H0V22.6541H14.0753ZM14.7626 0L23.8857 9.12311L22.2272 10.784L20.9839 10.3688L18.0785 13.2706L24.7138 19.9059L23.0553 21.5645L16.4211 14.9292L13.6014 17.7489L13.9333 19.0767L12.2736 20.7352L3.15051 11.6121L4.81022 9.95355L6.13564 10.2843L13.5181 2.90302L13.1041 1.65971L14.7626 0Z" fill="#EF981D"/>
                    </svg>
                      Live Auctions</Link></li>
                  </ul>
                </li>
                <li className="nav-item">
                <Link className="nav-link" to={'/marketplacecollection'}>Collections</Link>
                </li>
                <li className="nav-item">
                <Link className="nav-link" to="" tabindex="-1">Resources
                  <ul className="sub_menu">
                    <li><Link to={"/helpcenter"} className="active sub-items">Help Center</Link></li>
                    <li><Link to="" className="sub-items">Partners</Link></li>
                    <li><Link to={'/blog'} className="sub-items">Blog</Link></li>
                ...
                <li className="nav-item">
                <Link className="border_btn" to={'/login'}>log in</Link>
                </li>
                <li className="nav-item">
                <Link onClick={ requestAccount } className="main_btn" to="" tabindex="-1">{ showConected  }</Link>
                </li>
            </ul>
